...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
          <div class="titulo"><h1> <img src="img/icono-tit.png" alt=""> Italianisimmo <img src="img/icono-tit.png" alt=""> </h1></div>
      </div>
    </div>
      <div class="container"> 
        <div class="lines"> <img src="img/lines.png" class="img-responsive" alt=""></div>
          <div class="row"> 
            <div class="col-md-12">
              <img src="img/restaurantes/italianisimmo/italianisimmo.jpg" class="img-responsive" alt="">
            </div> <br><br>
        </div> 
      </div> 
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <img src="img/restaurantes/italianisimmo/logo.jpg" alt="">
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 text-info-1">
            <div class="col-md-6"> <br>
                <address>
                <p><span class="info-rest">Teléfono:</span> 423.4000 / 200.0988 <br><br>
                   <span class="info-rest">Dirección: </span>Av. Mirador No. 4723 - 2   <br> Chihuahua, México. <br><br>
