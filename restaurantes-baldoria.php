      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 text-rest">
            <h4></h4>
            <p><span class="titulo-rest"></span> Baldoria es un restaurante nuevo en la ciudad, inició sus operaciones en la ciudad de Torreón, cuenta con una sucursal en Gómez Palacio y ahora en Chihuahua. Es famoso por su excelente cocina italiana: pastas, ensaladas, calzone, panini, postres y las deliciosas pizzas al horno de leña que son toda una sensación. La selecta cava de vinos cierra el trato para esas comidas de negocios o reuniones con amigos y familia. (Ubicado en una de las mejores zonas comerciales de la ciudad).
 </p>

            <p>Baldoria is a new restaurant in town; it started in the city of Torreón and now has establishments in Gómez Palacio and just recently here in Chihuahua. Famous for its excellent Italian cuisine, the menu offers pastas, salads, calzone, Panini, desserts and the exquisite wood oven pizzas. The well-selected wine cellar seals the deal for those Business meals or gatherings with family and friends. (Located in very close to the main hotels). </p>

          </div>
          <div class="col-md-5 text-info-1">
            <div class="col-md-6"> <br>
                <address>
                <p><span class="info-rest">Teléfono:</span> 614 425.2595  <br><br>
                   <span class="info-rest">Dirección: </span>Perif. de la Juventud Vía Trentino  No. 5703 Plaza Distrito 1  <br><br>
