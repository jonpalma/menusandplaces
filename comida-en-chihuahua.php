...
<html lang="es">
  ...
  <body>
    ...
    <div class="container cont-sup">
      <div class="row">
          <div class="titulo"><h1> <img src="img/icono-tit.png" alt=""> Somos Callejeros <img src="img/icono-tit.png" alt=""> </h1></div>
      </div>
    </div>
    <!-- RESTAURANTES -->
    <div class="container"> 
      ...
      <div class="row"> 
        <div class="col-md-9 col-sm-9">
          <div class="">
            ...
            <div class="col-md-4 col-sm-6">
              <a href="restaurantes-akari.php"><img src="img/restaurantes/prueba.jpg" class="img-responsive" alt=""></a>
              <div class="info"><h4>BUFFALLO WILD WINGS</h4><p>Lorem ipsum dolor sit lectus, ratione ipsum invelis, reiciendis consequatur iste dolorum tempora dicta.</p></div>
            </div>
          </div>
      </div>
