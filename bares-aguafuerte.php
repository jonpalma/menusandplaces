...
<html lang="es">
  <head>
    ...
    <title>Menus and Places | Bares El Aguafuerte en Chihuahua</title>
    ...
    <meta name="keywords" content="Bares en chihuahua, bar el aguafuerte, el aguafuerte chihuahua, cantina, tiempos dorados, estilo antiguo, botana">
  ...
  <body>
    ...
    <!-- END / NOMBRE -->
      <div class="container"> 
        ...
        <div class="row"> 
          <div class="col-md-12">
            <img src="img/bares/aguafuerte/aguafuerte.jpg" class="img-responsive" alt="Bar El Aguafuerte Chihuahua">
          </div> <br><br>
        </div> 
      </div> 
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <img src="img/bares/aguafuerte/logo.jpg" alt="Logotipo El Aguafuerte">
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 text-info-1">
            <div class="col-md-6"> <br>
                <address>
                <p><span class="info-rest">Dirección: </span>Calle Victoria No. 823, Col. Centro  <br> Chihuahua, México. <br><br>
              ...
              <div class="col-md-12">
                ...
                <a href="#" class="element11"  data-toggle="tooltip" data-placement="top" title="Música en vivo"><img src="img/iconos/11.png" alt="música en vivo"></a>
              </div>
            </div> 
          </div> <br>
        </div>
