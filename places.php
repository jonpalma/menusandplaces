...
<html lang="es">
  ...
  <body>
    ...
    <div class="container cont-sup">
      <div class="row">
          <div class="titulo"><h1> <img src="img/icono-tit.png" alt=""> Places <img src="img/icono-tit.png" alt=""> </h1></div>
      </div>
    </div>
    <!-- RESTAURANTES -->
    <div class="container"> 
      ...
      <div class="row"> 
        <div class="col-md-9 col-sm-9">
          <div class="">
            ...
            <div class="col-md-4 col-sm-6">
              <a href="places-elefantebastilla.php"><img src="img/places/elefantebastilla/thumb.jpg" class="img-responsive" alt=""></a>
