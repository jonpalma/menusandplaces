...
<html lang="es">
  <head>
    ...
    <title>Menus and Places | Places en Chihuahua</title>
    ...
    <meta name="keywords" content="Places en chihuahua, lugares chihuahua, el hojaldre chihuahua, el elefante de la bastilla chihuahua, betty cookie chihuahua, café méxico corazón chihuahua">
  ...
  <body>
    ...
    <div class="container cont-sup">
      <div class="row">
          <div class="titulo"><h1> <img src="img/icono-tit.png" > Places <img src="img/icono-tit.png" > </h1></div>
      </div>
    </div>
    <!-- RESTAURANTES -->
    <div class="container"> 
      ...
      <div class="row"> 
        <div class="col-md-9 col-sm-9">
          <div class="">
            ...
            <div class="col-md-4 col-sm-6">
              <a href="places-elefantebastilla.php"><img src="img/places/elefantebastilla/thumb.jpg" class="img-responsive" alt="Places El Elefante De La Bastilla Chihuahua"></a>
          ...
          <div class="">
            <div class="col-md-4 col-sm-6">
              <a href="restaurantes-cafemexico.php"><img src="img/restaurantes/cafemexico/thumb.jpg" class="img-responsive" alt="Places Café México Corazón Chihuahua"></a>
